...
export class JogoDaVelhaService {
  ...
  /**
   * Inicializar tabuleiro do jogo com vazio para todas as posições
   * 
   * @return void
   */
   ...
   * @return boolean
   * 
   * (acessor para variável privada - retorna o valor)
   */
  ...
  /**
   * Lógica para simular jogada do CPU em modo aleatório.
   * 
   * @return void
   */
  cpuJogar(): void {
  ...
  /**
   * Retorna se a marcação de vitória deve ser exibida para a corrdenada informada
   * 
   * @param number posX
   * @param number posY
   * @return boolean
